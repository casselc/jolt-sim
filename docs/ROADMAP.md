...
| --- | --- | --- |
| Jolt 0.6.4 / ABI 6 / FFI descriptor 8 simulation image | Pushed to the integration branch and fork `main`; focused compiler and whole-application consumer gates are green; hosted CI pending | Integration `c2a8285b` / draft PR `casselc/jolt#37`; variadic FFI `76542302`; reminted seed `cf240c7b`; exact target facts `9c4c75ef`; Windows absolute-root fix `c2a8285b`; local FFI `10/10 + 59/59 + 38/38 + 26/26 + 21/21`, declared `59/59`, native `107/107`, controller `170/170`, target `99/99`, unit `1236/1236`; unchanged jolt-sim consumers: POSIX `95/95`, HTTP `33/33`, TCP/bencode `101/101`, SQLite `34/34`, webhook simulation `149/149` |
