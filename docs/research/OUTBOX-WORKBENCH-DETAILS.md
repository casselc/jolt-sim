# Outbox workbench implementation details

This is the detailed implementation and gate record for the Outbox workbench.
Start with the short [Outbox workbench guide](../../examples/outbox-workbench/README.md)
...
file. The checked-in [`config/ripple-eval.edn`](../../examples/outbox-workbench/config/ripple-eval.edn) is
