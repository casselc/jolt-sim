# Ripple implementation details

This is the detailed design and boundary record for Ripple. Start with the
short [Ripple guide](../../viewer/README.md) for installation and controls.
The guide links here when you need configuration, embedding, replay, or
security detail.
...
plan. [`examples/experiment-plan.edn`](../../viewer/examples/experiment-plan.edn) is an
...
Copy [`example-config.edn`](../../viewer/example-config.edn), replace the absolute paths,
...
[![Ripple persistent Jolt REPL session](../../viewer/docs/ripple-persistent-eval-session.png)](../../viewer/docs/ripple-persistent-eval-session.png)
...
topology [`examples/maelstrom-echo-plan.edn`](../../viewer/examples/maelstrom-echo-plan.edn):
...
[`examples/outbox-regime-lab-plan.edn`](../../viewer/examples/outbox-regime-lab-plan.edn).
...
[`examples/maelstrom-broadcast-plan.edn`](../../viewer/examples/maelstrom-broadcast-plan.edn):
...
Its inert plan
projection is
[`examples/outbox-json-idempotency-plan.edn`](../../viewer/examples/outbox-json-idempotency-plan.edn):
...
[`examples/outbox-cancel-before-ack-plan.edn`](../../viewer/examples/outbox-cancel-before-ack-plan.edn)
[`examples/maelstrom-echo-plan.edn`](../../viewer/examples/maelstrom-echo-plan.edn),
[`examples/outbox-regime-lab-plan.edn`](../../viewer/examples/outbox-regime-lab-plan.edn),
[`examples/maelstrom-broadcast-plan.edn`](../../viewer/examples/maelstrom-broadcast-plan.edn),
and
[`examples/outbox-json-idempotency-plan.edn`](../../viewer/examples/outbox-json-idempotency-plan.edn)
...
[![Ripple running the compiled outbox example](../../viewer/docs/ripple-run-new-outbox.png)](../../viewer/docs/ripple-run-new-outbox.png)
...
[![Ripple retained semantic activity page](../../viewer/docs/ripple-retained-activity.png)](../../viewer/docs/ripple-retained-activity.png)
