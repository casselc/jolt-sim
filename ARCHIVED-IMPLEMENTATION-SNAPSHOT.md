# Archived jolt-sim implementation snapshot

> [!CAUTION]
> This is the former repository README from commit `e3ecc507`. It is preserved
> as a historical snapshot, not maintained as current setup guidance. Version
> pins, CI descriptions, machine paths, and “current” claims below can be
> stale. Use the [project README](README.md),
> [prerequisites](docs/PREREQUISITES.md), and
