# Archived Ripple README snapshot

> [!CAUTION]
> This is the former Ripple README from commit `e3ecc507`. It is preserved for
> historical detail, not maintained as current setup guidance. Machine paths,
> endpoint descriptions, and “current” claims below can be stale. Start with
> the [current Ripple guide](README.md), the
> [prerequisites](../docs/PREREQUISITES.md), and the
> [current verification reference](../docs/reference/IMPLEMENTATION-AND-VERIFICATION.md).
...
- [Broadcast prepared and committed cells](../examples/maelstrom-broadcast-workbench/README.md#preview-a-command-before-publication)
