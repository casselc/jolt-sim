# Archived Outbox workbench README snapshot

> [!CAUTION]
> This is the former example README from commit `e3ecc507`. It is preserved for
> historical detail, not maintained as current setup guidance. In particular,
> its machine-specific worktree paths and Jolt version notes are snapshots.
> Start with the [current Outbox guide](README.md), the
