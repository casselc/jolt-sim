...
(defn respond-begin
  ...
  than on a transition of ResponseBody's own machine BECAUSE of the defect in
  the paragraph above: this operation cannot be one of that machine's
  transitions. See `perturb.cap/refinements`."
  {:perturb.cap/op {:consumes [{:cap 'perturb.http/ServerConn :state :responding :arg 0}]
